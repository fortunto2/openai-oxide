...
37% faster agent loops via persistent connection reuse.
...
Sends 2 identical requests with a delay; returns whichever finishes first. 50-96% P99 improvement.
