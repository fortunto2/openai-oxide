...
pub struct ChoiceLogprobs {
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub refusal: Option<Vec<serde_json::Value>>,
}
...
pub struct ChoiceDelta {
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub role: Option<ChoiceDeltaRole>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
pub struct ChunkChoice {
    ...
    /// The reason the model stopped generating tokens.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub finish_reason: Option<ChunkChoiceFinishReason>,
    /// The index of the choice in the list of choices.
    pub index: i64,
    /// Log probability information for the choice.
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
pub struct ChatCompletionChunk {
    ...
    /// Specifies the processing type used for serving the request.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub service_tier: Option<ChatCompletionChunkServiceTier>,
    /// This fingerprint represents the backend configuration that the model runs with.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub system_fingerprint: Option<String>,
...
pub struct Annotation {
    ...
    pub type_: String,
    /// A URL citation when using web search.
    pub url_citation: serde_json::Value,
}
...
pub type ResponseFormat = serde_json::Value;
...
pub struct WebSearchOptionsUserLocation {
    /// Approximate location parameters for the search.
    pub approximate: serde_json::Value,
...
pub struct WebSearchOptions {
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub search_context_size: Option<WebSearchOptionsSearchContextSize>,
    /// Approximate location parameters for the search.
    #[serde(skip_serializing_if = "Option::is_none", default)]
